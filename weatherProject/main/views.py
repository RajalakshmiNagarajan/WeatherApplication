...
def index(request):
    if request.method == 'POST':
        ...
        currentWeather = CurrentWeatherStatus(country_code=data['country_code'], dt_in_api=data['dt_in_api'],
        ...
        currentWeather.save()
        responds_data = {"current_weather": currentWeather}
...
def chart(request):
    ...
    chart_array = [['city_name', 'temperature'], [data_arr[0], temp_arr[0]], [data_arr[1], temp_arr[1]],
                   [data_arr[2], temp_arr[2]]
        , [data_arr[3], temp_arr[3]], [data_arr[4], temp_arr[4]], [data_arr[5], temp_arr[5]]]
    # need to iterate and push to a table in html
